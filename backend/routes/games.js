...
const GAME_CATALOG = [
  ...
  {
    id: 'g-09',
    slug: 'back-attacker-elite',
    title: 'Back Attacker Elite',
    description: 'Advanced variant unlocked at Quest 9.',
    required_level: 9,
    root_dir: '../../back-attacker',
    entry_file: 'index.html'
  },
  {
    id: 'g-10',
    slug: 'tilting-maze-master',
    title: 'Tilting Maze Master',
    description: 'Master maze challenge unlocked at Quest 10.',
    required_level: 10,
    root_dir: '../../Tilting Maze Game',
    entry_file: 'index.html'
  }
